...
using Pharamacy.Common.PersianToolkit;
...
using Pharamacy.DataLayer.Mappings;
using Microsoft.EntityFrameworkCore.Infrastructure;
using Microsoft.Extensions.DependencyInjection;
using Pharamacy.Entities.Stock;

namespace Pharamacy.DataLayer.Context
{
    /// <summary>
        ...
        IUnitOfWork
    {
        ...
        public virtual DbSet<Shelf> Shelves { set; get; }
